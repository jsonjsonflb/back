...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      addAnalyst: "analyst/addAnalyst",
      delAnalyst: "analyst/delAnalyst",
      updateAnalyst: "analyst/updateAnalyst"
    }),
    resetAllStatus() {
      this.form = {
        analystName: "",
    ...
    handleEdit(row) {
      ...
      this.isEdit = true;
      console.log(data.vipGradeAnalyst);
    },
